 ...
 */
export declare const schema: "HTP-1.0";
export type HarmCategory = 'physical' | 'financial' | 'reputational' | 'psychological' | 'operational' | 'legal' | 'environmental' | 'informational' | 'discriminatory';
export type Severity = 'negligible' | 'minor' | 'moderate' | 'serious' | 'critical' | 'catastrophic';
export type CausationType = 'direct' | 'contributing' | 'enabling' | 'proximate' | 'but_for';
...
export type PropagationPatternType = 'cascade' | 'amplification' | 'delayed' | 'cross_domain' | 'feedback_loop';
